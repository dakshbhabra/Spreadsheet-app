...
$(document).ready(function () {
  ...
  function changeHeader(ele) {
    ...
    // let fontStyle = cellInfo["font-family"];
...
$(".font-family-selector").change(function (_e) {
  let val = this.value;
  updateCell("font-family", val, true);
  $(".font-family-selector").css("font-family", val);
});

$(".font-size-selector").change(function () {
  let val = this.value;
  updateCell("font-size", val, true);
});
    ...
    if ($(".sheet-options-modal").length == 0) {
      ...
      $(".sheet-rename").click(function () {
        if($(".sheet-rename-modal").length == 0) {
          ...
          <h4 class="modal-tittle">Rename Sheet To:</h4>
